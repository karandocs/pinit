...
class FrameworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create framework" do
    assert_difference('Framework.count') do
      post frameworks_url, params: { framework: { active: @framework.active, name: @framework.name, position: @framework.position } }
    end
  ...
  test "should update framework" do
    patch framework_url(@framework), params: { framework: { active: @framework.active, name: @framework.name, position: @framework.position } }
